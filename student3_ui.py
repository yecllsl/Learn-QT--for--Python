...
################################################################################
## Form generated from reading UI file 'student3.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_6.setBuddy(self.name)
        self.label_7.setBuddy(self.number)
        self.label.setBuddy(self.Chinese)
        self.label_2.setBuddy(self.math)
        self.label_3.setBuddy(self.english)
#endif // QT_CONFIG(shortcut)
        QWidget.setTabOrder(self.name, self.number)
        QWidget.setTabOrder(self.number, self.btnCalculate)
        QWidget.setTabOrder(self.btnCalculate, self.btnSave)
        QWidget.setTabOrder(self.btnSave, self.btnClose)
        QWidget.setTabOrder(self.btnClose, self.Chinese)
        QWidget.setTabOrder(self.Chinese, self.math)
        QWidget.setTabOrder(self.math, self.english)
        QWidget.setTabOrder(self.english, self.total)
        QWidget.setTabOrder(self.total, self.average)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_6.setText(QCoreApplication.translate("Form", u"\u59d3\u540d(&N)", None))
        self.label_7.setText(QCoreApplication.translate("Form", u"\u5b66\u53f7(&B)", None))
        self.groupBox.setTitle(QCoreApplication.translate("Form", u"\u5b66\u751f\u6210\u7ee9\uff1a", None))
        self.label.setText(QCoreApplication.translate("Form", u"\u8bed\u6587(&C)", None))
        self.label_2.setText(QCoreApplication.translate("Form", u"\u6570\u5b66(&M)", None))
        self.label_3.setText(QCoreApplication.translate("Form", u"\u82f1\u8bed(&E)", None))
