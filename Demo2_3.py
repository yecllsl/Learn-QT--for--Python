...
class TestFont(QWidget):
    ...
    def getLabelFont(self):
        ...
        for i in self.labels:
            f = i.font()
            print(template.format(j, f.family(), f.bold(), f.italic(), f.strikeOut(), f.overline(),
                                  f.underline(), f.capitalization(), f.weight(), f.wordSpacing(),
                                  f.stretch(), f.pixelSize(), f.pointSize()))
            j += 1
